...
CREATE INDEX idx_movies_imdb_rating ON movies(imdb_rating DESC);
...
CREATE INDEX idx_series_imdb_rating ON series(imdb_rating DESC);

CREATE INDEX idx_favorites_user_id ON favorites(user_id);
CREATE INDEX idx_favorites_content ON favorites(content_id, content_type);

CREATE INDEX idx_watch_history_user_id ON watch_history(user_id);
CREATE INDEX idx_watch_history_content ON watch_history(content_id, content_type);
